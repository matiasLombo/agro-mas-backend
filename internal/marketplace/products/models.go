...
type UpdateProductRequest struct {
	...
	LivestockDetails    *LivestockDetails   `json:"livestock_details,omitempty"`
	SuppliesDetails     *SuppliesDetails    `json:"supplies_details,omitempty"`
	ExistingImages      []ExistingImageInfo `json:"existing_images,omitempty"`
}

type ExistingImageInfo struct {
	ID           string `json:"id"`
...
type ProductSearchRequest struct {
	...
	ExcludeUserID     *uuid.UUID `json:"-"` // Exclude products from this user (not exposed in JSON)
}
